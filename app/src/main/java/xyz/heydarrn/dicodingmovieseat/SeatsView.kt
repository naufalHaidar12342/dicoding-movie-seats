...
class SeatsView : View {
    ...
    private val seats: ArrayList<Seats> = arrayListOf(
        ...
        Seats(id = 3, name = "B1", isBooked = false),
        Seats(id = 4, name = "A4", isBooked = false),
        Seats(id = 5, name = "C1", isBooked = false),
        Seats(id = 6, name = "C2", isBooked = false),
        Seats(id = 7, name = "D1", isBooked = false),
        Seats(id = 8, name = "D2", isBooked = false),
    )
